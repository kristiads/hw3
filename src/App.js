...
//function to take the first five cards in the shuffled deck
  dealHand() {
    this.setState({
      hand: shuffledDeck().splice(5)
    })
  }
  ...
  render() {
    ...
    //fill in the card array with images of card in hand array
    for (let i=0; i<5; i++) {
      let cardImage = "http://golearntocode.com/images/cards/" + this.state.hand[i] + ".png";
      cards.push(<img src={cardImage} key={i} alt="Card"/>);
    }
